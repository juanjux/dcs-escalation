...
def test_migrate_game_rehomes_motorpools_after_all_migrations() -> None:
    ...
    method_names = [
        ...
        "_enrol_iads_sites_the_campaign_never_named",
        "_wire_iads_sites_that_arrived_late",
        "_unwire_iads_ships",
        "_renew_stale_iads_nodes",
    ...
    # Migration re-homes and stops: the groups are ephemeral and must not be saved.
