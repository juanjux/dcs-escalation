...
class Faction:
    ...
    def apply_mod_settings(self, mod_settings: Optional[ModSettings] = None) -> None:
        ...
        if not mod_settings.f15ex:
            self.remove_aircraft("F15EX")
        if not mod_settings.f15cge:
            self.remove_aircraft("F15CGE")
        ...
        if not mod_settings.swedishmilitaryassetspack:
            ...
            self.remove_vehicle("CH_LvS-103_Lavett103_Rb103A")
            self.remove_vehicle("CH_LvS-103_Lavett103_Rb103B")
            self.remove_vehicle("CH_LvS-103_Lavett103_HX_Rb103A")
            self.remove_vehicle("CH_LvS-103_Lavett103_HX_Rb103B")
            self.remove_vehicle("CH_LvS-103_StriE103")
            self.remove_vehicle("CH_LvS-103_PM103")
            self.remove_vehicle("CH_LvS-103_PM103_HX")
            self.remove_vehicle("CH_LvS-103_Elverk103")
        ...
        # german military assets pack
        if not mod_settings.germanymilitaryassetspack:
            self.remove_vehicle("CH_Leopard2A7V")
            self.remove_vehicle("CH_Marder1A5")
            self.remove_vehicle("CH_PumaA1")
            self.remove_vehicle("CH_Boxer")
            self.remove_vehicle("CH_BoxerCRV")
            self.remove_vehicle("CH_Wiesel1A4")
            self.remove_vehicle("CH_EagleIV")
            self.remove_vehicle("CH_PZH2000_M1711")
            self.remove_vehicle("CH_PZH2000_M982")
            self.remove_vehicle("CH_BoxerSkyranger")
            self.remove_vehicle("CH_FlaRakRad")
            self.remove_vehicle("CH_Wiesel2Ozelot")
            self.remove_vehicle("CH_SkynexHX")
            self.remove_vehicle("CH_Skyshield_FCU")
            self.remove_vehicle("CH_Skyshield_Gun")
            ...
            self.remove_vehicle("CH_HX60")
            self.remove_vehicle("CH_HX77")
            self.remove_vehicle("CH_HX81")
