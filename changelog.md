...
* **[UI]** The location dialog of a unit objective was redrawn: a header with what the site is and how much of it is standing, units under their groups with what each one is for, identical ones folded, and -- for an air-defence site -- the IADS chain behind it: which radar cues it, which command centre directs it and what powers it.
