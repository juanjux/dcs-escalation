...
* **[UI]** The location dialog was redrawn: a header with what the objective is and how much of it is standing, units under their groups with what each one is for, buildings as rows with what they pay and how long a repair takes to pay for itself, and -- for an air-defence site -- the IADS chain behind it: which radar cues it, which command centre directs it and what powers it.
