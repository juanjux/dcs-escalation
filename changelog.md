...
* **[High Command]** Each turn the High Command orders three enemy objectives taken, one from each third of them by difficulty plus importance, for two to five turns and each with its prize. Achieving one pays it, at once or as a ticket kept to spend later. No window shows them yet.
