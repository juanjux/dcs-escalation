...
* **[High Command]** When GeneraLLM plays the enemy, the enemy's High Command makes requests against the player's objectives and pays their prizes; GeneraLLM reads them and spends its tickets through its API.
...
* **[High Command]** The debriefing lists the requests the mission achieved and what each pays.
